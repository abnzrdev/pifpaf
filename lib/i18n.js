const ru = {
  ...
  login: { eyebrow: 'С возвращением ✨', title: 'Войти в пространство автора', description: 'Все Reels и их результаты — без лишних таблиц.', email: 'Email', password: 'Пароль', pending: 'Входим…', submit: 'Войти', error: 'Неверный email или пароль.', accounts: 'Тестовые аккаунты', demo: 'С данными', empty: 'Пустой кабинет', imageAlt: 'Автор улыбается на улице', imageCopy: ['Ваши истории.', 'Одно спокойное пространство.'] },
...
export const LOCALE_COOKIE = 'pifpaf-locale-v2'

const ruErrors = new Map([
  ['Enter a valid public Instagram Reel URL.', 'Введите корректную ссылку на публичный Instagram Reel.'],
  ['This Instagram post is not a public Reel.', 'Этот пост Instagram не является публичным Reel.'],
